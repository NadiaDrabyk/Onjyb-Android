...
public class UserHelper implements AsyncTaskCompleteListener<String> {
    ...
    public void apiregisterDeviceForNotification(ActionCallback actionCallback, String regId) {
        try {
            ...
            map.put("os", "android");
            ETechAsyncTask task = new ETechAsyncTask(this.context, this, Constants.URL_REGISTER_DEVICE, map, 2, true, true);
    ...
    public void apiGetUnReadCount(ActionCallback actionCallback) {
        try {
            ...
            ETechAsyncTask task = new ETechAsyncTask(this.context, this, Constants.URL_GET_UNREAD_COUNT, map, 2, true, true);
            task.hideProgressDialog();
    ...
    public void apiLogOut(ActionCallback actionCallback) {
        try {
            ...
            ETechAsyncTask task = new ETechAsyncTask(this.context, this, Constants.URL_LOGOUT_USER, map, 2, true, true);
            task.hideProgressDialog();
    ...
    public void apiUserLogin(User userdata, ActionCallback actionCallback) {
        try {
            ...
            ETechAsyncTask task = new ETechAsyncTask(this.context, this, Constants.URL_LOGIN, map, 2, true, true);
            task.hideProgressDialog();
    ...
    public void apigetMessages(String compId, int pageNo, ActionCallback actionCallback) {
        try {
            ...
            ETechAsyncTask task = new ETechAsyncTask(this.context, this, Constants.URL_GET_MESSAGES, map, 2, true, true);
            task.hideProgressDialog();
    ...
    public void apiSendGroupMessage(String userId, String compId, String Msg, ActionCallback actionCallback) {
        try {
            ...
            ETechAsyncTask task = new ETechAsyncTask(this.context, this, Constants.URL_GROUP_CHAT, map, 2, true, true);
            task.hideProgressDialog();
    ...
    public void apiProfiledisplay(String userId, ActionCallback actionCallback) {
        try {
            ...
            ETechAsyncTask task = new ETechAsyncTask(this.context, this, Constants.URL_PROFILE_DISPLAY, map, 2, true, true);
            task.hideProgressDialog();
    ...
    public void apiChangePassword(String userId, String oldPsw, String newPsw, String resetPsw, ActionCallback actionCallback) {
        try {
            ...
            ETechAsyncTask task = new ETechAsyncTask(this.context, this, Constants.URL_CHANGE_PASSWORD, map, 2, true, true);
            task.hideProgressDialog();
    ...
    public void apiForgotPassword(User userdata, ActionCallback actionCallback) {
        try {
            ...
            HashMap<String, Object> map = new HashMap();
            map.put("txtEmail", userdata.getEmail());
            new ETechAsyncTask(this.context, this, Constants.URL_FORGOT_PASSWORD, map, 2, true, true).execute(new String[]{Constants.URL_FORGOT_PASSWORD});
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void apiGetMasterTablesDetail(ActionCallback actionCallback) {
        try {
            ...
            new ETechAsyncTask(this.context, this, Constants.URL_MASTER_LIST, map, 2, true, true).execute(new String[]{Constants.URL_MASTER_LIST});
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void apiGetWorksheetDetails(WorkSheet workSheet, ActionCallback myTaskDetailCallback) {
        try {
            ...
            new ETechAsyncTask(this.context, this, Constants.URL_MYTASK_WORKSHEET_DETAIL, map, 2, true, true).execute(new String[]{Constants.URL_MYTASK_WORKSHEET_DETAIL});
    ...
    public void apiCallRejectTask(ActionCallback actionCallback, WorkSheet workSheet) {
        try {
            ...
            new ETechAsyncTask(this.context, this, Constants.URL_REJECT_TASK, map, 2, true, true).execute(new String[]{Constants.URL_REJECT_TASK});
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void apigetGraphDetails(String projectId, ActionCallback actionCallback) {
        try {
            ...
            new ETechAsyncTask(this.context, this, Constants.URL_GRAPH_DETAIL, map, 2, true, true).execute(new String[]{Constants.URL_GRAPH_DETAIL});
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void apiGetTaskListWithTotal(ActionCallback actionCallback, String status, int pageNo, String pro_id, String Ser_id, String Branch_id, String employeeId, String startDate, String enddate, boolean issummary, boolean is_mng_jobber) {
        try {
            ...
            new ETechAsyncTask(this.context, this, Constants.URL_MYTASK_WORKSHEET_LIST, map, 2, true, true).execute(new String[]{Constants.URL_MYTASK_WORKSHEET_LIST});
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
